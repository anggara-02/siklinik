		...
		<div class="p-4 border-bottom border-light">
			<div class="row mx-n2">
				<div class="col-md-auto mb-3 mb-md-0 px-2">
					<a href="?page=inventori-barang-masuk-form" class="btn btn-primary">Tambah</a>
				</div>
					...
					<tbody>
						<tr>
							...
							<td class="text-nowrap">
								<a href="?page=inventori-barang-masuk-form" class="btn btn-info btn-icon"><i class="fa fa-edit"></i></a>
								<a href="#" class="btn btn-danger btn-icon btn-delete"><i class="fas fa-trash"></i></a>
							</td>
							<td>18-11-2021</td>
							<td>Pagi</td>
							<td>Belanja stok 1 bulan</td>
...
<script type="text/javascript">
	$('.sidebar-menu > li > a:contains("Inventori")').parent().addClass('active').find('a:contains("Barang Masuk")').parent().addClass('active');
</script>
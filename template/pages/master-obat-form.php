		...
		<div class="card-body">
			<form action="#" method="POST" class="needs-validation" novalidate="">
				...
				<div class="form-group row mb-4">
					...
					<div class="col-sm-12 col-md-7">
						<select name="" id="" class="form-input form-select2" style="width: 100%;" data-placeholder="Pilih Jenis Obat">
							<option value=""></option>
				...
				<div class="form-group row mb-4">
					...
					<div class="col-sm-12 col-md-7">
						<select name="" id="" class="form-input form-select2" style="width: 100%;" data-placeholder="Pilih Satuan Dosis">
							<option value=""></option>
							<option>Mg</option>
							<option>Ml</option>
						</select>
						<div class="invalid-feedback">
							Masukkan Satuan Dosis
						</div>
					</div>
				</div>
				<div class="form-group row mb-4">

		...
		<div class="p-4 border-bottom border-light">
			<div class="row mx-n2">
				<div class="col-md-auto mb-3 mb-md-0 px-2">
					<a href="?page=transaksi-apotek-tambah" class="btn btn-primary">Tambah</a>
				</div>
					...
					<tbody>
						<tr>
							...
							<td class="text-nowrap">
								...
								<a href="?page=#" class="btn btn-warning btn-icon tooltips" title="Cetak Struk"><i class="fa fa-print"></i></a>
								<a href="?page=#" class="btn btn-success btn-icon tooltips" title="Cetak Resep"><i class="fa fa-print"></i></a>

<div class="section-header">
    ...
    <div class="section-header-breadcrumb">
     	<div class="breadcrumb-item"><a href="#">Dashboard</a></div>
      	...
      	<div class="breadcrumb-item">Satuan Dosis</div>
    </div>
</div>
...
<script type="text/javascript">
	$('.sidebar-menu > li > a:contains("Data Master")').parent().addClass('active').find('a:contains("Satuan Dosis")').parent().addClass('active');
</script>
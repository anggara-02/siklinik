<div class="section-header">
    ...
    <div class="section-header-breadcrumb">
     	<div class="breadcrumb-item"><a href="#">Data Master</a></div>
      	<div class="breadcrumb-item">Item Belanja</div>
    </div>
</div>
...
<script type="text/javascript">
	$('.sidebar-menu > li > a:contains("Data Master")').parent().addClass('active').find('a:contains("Item Belanja")').parent().addClass('active');
</script>
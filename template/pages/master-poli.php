<div class="section-header">
    ...
    <div class="section-header-breadcrumb">
     	<div class="breadcrumb-item"><a href="#">Dashboard</a></div>
      	...
      	<div class="breadcrumb-item">Poli</div>
    </div>
</div>
					...
					<tbody>
						<tr>
							...
							<td class="text-nowrap">
								<a href="?page=#" class="btn btn-info btn-icon disabled" data-toggle="modal" data-target="#modal-form"><i class="fa fa-edit"></i></a>
...
<script type="text/javascript">
	$('.sidebar-menu > li > a:contains("Data Master")').parent().addClass('active').find('a:contains("Poli")').parent().addClass('active');
</script>
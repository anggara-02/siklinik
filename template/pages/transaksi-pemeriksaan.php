		...
		<div class="p-4 border-bottom border-light">
			<div class="row mx-n2">
				<div class="col-md-auto mb-3 mb-md-0 px-2">
					<!-- <a href="?page=transaksi-pemeriksaan-form" class="btn btn-primary">Tambah</a> -->
				</div>
					...
					<tbody>
						<tr>
							...
							<td class="text-nowrap">
								<a href="?page=transaksi-pemeriksaan-form" class="btn btn-info btn-icon disabled"><i class="fa fa-edit"></i></a>
							</td>
							<td>003</td>
							<td>000003</td>
							<td>11-11-2021</td>
						...
						<tr>
							<td>2</td>
							<td class="text-nowrap">
								<a href="?page=transaksi-pemeriksaan-form" class="btn btn-info btn-icon"><i class="fa fa-edit"></i></a>
							</td>
							<td>002</td>
							<td>000002</td>
							<td>11-11-2021</td>
						...
						<tr>
							...
							<td>BPJS</td>
							<td>
								<div class="badge badge-primary">Belum Diperiksa</div>
							</td>
						</tr>
					</tbody>
				</table>

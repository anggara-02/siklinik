		...
		<div class="p-4 border-bottom border-light">
			<div class="row mx-n2">
				<div class="col-md-auto mb-3 mb-md-0 px-2">
					<a href="?page=inventori-pemesanan-form" class="btn btn-primary">Tambah</a>
				</div>
				<div class="col-md-auto px-2 ml-auto">
					<div class="row">
						...
						<!-- <div class="col-md-3">
							<select name="" id="" class="form-select2" data-placeholder="Pilih Jenis SP">
								<option value=""></option>
								<option>Reguler</option>
								<option>Prekursor</option>
								<option>OOT</option>
								<option>Psikotropik</option>
					...
					<tbody>
						<tr>
							...
							<td rowspan="3" class="text-nowrap">
								<a href="?page=inventori-pemesanan-form" class="btn btn-info btn-icon"><i class="fa fa-edit"></i></a>
							...
							<td rowspan="3">001/Reguler/AF/XI/2021</td>
							<td rowspan="3">Reguler</td>
...
<script type="text/javascript">
	$('.sidebar-menu > li > a:contains("Inventori")').parent().addClass('active').find('a:contains("Pemesanan")').parent().addClass('active');
</script>
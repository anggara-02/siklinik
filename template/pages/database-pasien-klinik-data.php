<div class="section-header">
    ...
    <div class="section-header-breadcrumb">
     	...
     	<div class="breadcrumb-item"><a href="#">Pasien Klinik</a></div>
				...
				<table class="table">
					<tbody>
						<tr>
							...
							<td width="200">Nama Pasien Klinik</td>
							<td width="10" align="center">:</td>
			...
			<div class="p-4 border-bottom border-light">
				<div class="row mx-n2">
					<div class="col-md-auto mb-3 mb-md-0 px-2">
						<a href="?page=database-pasien-klinik" class="btn btn-primary">Simpan</a>
					</div>
				</div>
			</div>
			<div class="table-responsive">
					...
					<tbody>
						<tr>
							...
							<td class="text-nowrap">
								<a href="?page=database-pasien-klinik-form" class="btn btn-info btn-icon" target="_blank"><i class="fa fa-eye"></i></a>
							</td>
							<td>02-01-2021</td>
							<td>Umum</td>
						</tr>
...
<script type="text/javascript">
	$('.sidebar-menu li a:contains("Pasien Klinik")').parent().addClass('active');
</script>
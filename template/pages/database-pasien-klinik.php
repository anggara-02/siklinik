		...
		<div class="p-4 border-bottom border-light">
			<div class="row mx-n2">
				<div class="col-md-auto mb-3 mb-md-0 px-2">
					<!-- <a href="?page=database-pasien-klinik-data" class="btn btn-primary">Tambah</a> -->
				</div>
					...
					<tbody>
						<tr>
							...
							<td class="text-nowrap">
								<a href="?page=database-pasien-klinik-data" class="btn btn-info btn-icon"><i class="fa fa-edit"></i></a>
							</td>
							<td>000001</td>
							<td>Ronaldo</td>
							<td>Laki-laki</td>

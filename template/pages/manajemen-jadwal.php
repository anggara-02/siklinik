<div class="section-header">
    ...
    <div class="section-header-breadcrumb">
     	<div class="breadcrumb-item active"><a href="#">Dashboard</a></div>
      	<div class="breadcrumb-item">Manajemen Jadwal</div>
    </div>
</div>
		...
		<div class="p-4 border-bottom border-light">
			<div class="row mx-n2">
				<div class="col-md-auto mb-3 mb-md-0 px-2">
					<a href="?page=manajemen-jadwal-form" class="btn btn-primary">Tambah</a>
				</div>
					...
					<tbody>
						<tr>
							...
							<td class="text-nowrap">
								<a href="?page=manajemen-jadwal-form" class="btn btn-info btn-icon"><i class="fa fa-edit"></i></a>

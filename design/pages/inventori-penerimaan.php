		...
		<div class="p-4 border-bottom border-light">
			<div class="row mx-n2">
				<div class="col-md-auto mb-3 mb-md-0 px-2">
					<a href="?page=inventori-penerimaan-form" class="btn btn-primary">Tambah</a>
				</div>
					...
					<tbody>
						<tr>
							...
							<td rowspan="3" class="text-nowrap">
								<a href="?page=inventori-penerimaan-form" class="btn btn-info btn-icon"><i class="fa fa-edit"></i></a>

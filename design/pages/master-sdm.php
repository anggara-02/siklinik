<div class="section-header">
    ...
    <div class="section-header-breadcrumb">
     	<div class="breadcrumb-item"><a href="#">Dashboard</a></div>
      	...
      	<div class="breadcrumb-item">SDM</div>
    </div>
</div>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="form-group">
					<label for="" class="form-label">Nama SDM</label>
					<input type="text" class="form-control">
				</div>
				<div class="form-group">
					<label for="" class="form-label">Jabatan</label>
					<select name="" id="" class="form-input form-select2" style="width: 100%;" data-placeholder="Pilih Jabatan">
						<option value=""></option>
						<option>Staff</option>
...
<script type="text/javascript">
	$('.sidebar-menu > li > a:contains("Data Master")').parent().addClass('active').find('a:contains("SDM")').parent().addClass('active');
</script>
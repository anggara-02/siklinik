			...
			<div class="table-responsive">
				<table class="table">
					<tbody>
						...
						<tr>
							<td width="200">Tgl Pemeriksaan</td>
							<td width="10" align="center">:</td>
							<td>01-01-2021</td>
							<td width="200">Poli</td>
							<td width="10" align="center">:</td>
							<td>Umum</td>
						</tr>
					</tbody>
			...
			<form action="#" method="POST" class="needs-validation" novalidate="">
				<div class="form-group row mb-4">
					...
					<div class="col-sm-12 col-md-7">
						<textarea name="" id="" cols="30" rows="5" class="form-control h-auto" readonly="">Tidak ada alergi</textarea>
				...
				<div class="form-group row mb-4">
					...
					<div class="col-sm-12 col-md-2">
						...
						<input type="text" class="form-control" required readonly="" value="70 KG">
						<div class="invalid-feedback">
					...
					<div class="col-sm-12 col-md-2">
						...
						<input type="text" class="form-control" required readonly="" value="175 CM">
						<div class="invalid-feedback">
				...
				<div class="form-group row mb-4">
					...
					<div class="col-sm-12 col-md-2">
						...
						<input type="text" class="form-control" required readonly="" value="130-150/80-90 mmHg">
						<div class="invalid-feedback">
					...
					<div class="col-sm-12 col-md-2">
						...
						<input type="text" class="form-control" required readonly="" value="16-20 x/menit">
						<div class="invalid-feedback">
				...
				<div class="form-group row mb-4">
					...
					<div class="col-sm-12 col-md-2">
						<label>Nadi</label>
						<input type="text" class="form-control" required readonly="" value="70-80 x/menit">
						<div class="invalid-feedback">
							Masukkan Nadi
						</div>
					</div>
					<div class="col-sm-12 col-md-2">
						...
						<input type="text" class="form-control" required readonly="" value="36,7 Celcius">
						<div class="invalid-feedback">
							Masukkan Suhu Tubuh
						</div>
					</div>
				...
				<div class="form-group row mb-4">
					...
					<div class="col-sm-12 col-md-7">
						<textarea name="" id="" cols="30" rows="5" class="form-control h-auto" readonly="">Normal</textarea>
						<div class="invalid-feedback">
							Masukkan Anamnesis
						</div>
					</div>
				...
				<div class="form-group row mb-4">
					<label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Pasien Fisik</label>
					<div class="col-sm-12 col-md-7">
						<textarea name="" id="" cols="30" rows="5" class="form-control h-auto" readonly="">Normal</textarea>
						<div class="invalid-feedback">
							Masukkan Pasien Fisik
						</div>
					</div>
				</div>
				<div class="form-group row mb-4">
							...
							<table class="table table-product2 table-bordered table-sm">
								...
								<tbody>
									<tr>
										...
										<td><div class="badge badge-info">Download</div></td>
									</tr>
								</tbody>
							</table>
						</div>
				...
				<div class="form-group row mb-4">
					<label class="col-form-label text-md-right col-12 col-md-3 col-lg-3"></label>
					<div class="col-sm-12 col-md-7">
						<a href="?page=database-pasien-data" class="btn btn-danger btn-icon">Kembali</a>
					</div>
				</div>
			</form>
		</div>

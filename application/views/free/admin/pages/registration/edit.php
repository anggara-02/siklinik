            ...
            <div class="box box-success">
				...
				<div class="form-group row mb-4 hidden">
					...
					<div class="col-sm-12 col-md-7">
						<input type="text" class="form-control" readonly id="search_pasien" name="search_pasien"  value="<?php echo $this->input->post('search_pasien')?$this->input->post('search_pasien'):(isset($search_pasien)?$search_pasien:''); ?>">
				...
				<div class="form-group row mb-4">
					...
					<div class="col-sm-12 col-md-7">
						<input type="text" class="form-control" name="xxx" readonly maxlength="255" required value="<?php echo $this->input->post('pendaftaran_pasien_rm')?$this->input->post('pendaftaran_pasien_rm'):(isset($pendaftaran_pasien_rm)?$pendaftaran_pasien_rm:''); ?>"> 
						...
						<div class="form-clone-wrap">
							<div class="form-group row mb-3 mx-n1 form-original4">
								<div class="col-md-11 px-1">
									<select name="div_pendaftaran_layanan_pemeriksaan_id" id="div_pendaftaran_layanan_pemeriksaan_id" class="form-input form-select2 form-control" style="width: 100%;" data-placeholder="Pilih Pemeriksaan">
										<option value="">Silahkan Pilih</option>
								...
								<tbody class="row_add">
									...
									?>
										...
										else if(!empty($detail))
										{
											...
											{
												$index=0;
												$pendaftaran_layanan_layanan_name[$index]=$arr['pendaftaran_layanan_layanan_name'];
												$pendaftaran_layanan_layanan_id[$index]=$arr['pendaftaran_layanan_layanan_id'];
												$pendaftaran_layanan_dokter_id[$index]=$arr['pendaftaran_layanan_dokter_id'];
												$pendaftaran_layanan_dokter_name[$index]=$arr['pendaftaran_layanan_dokter_name'];
												$pendaftaran_layanan_perawat_id[$index]=$arr['pendaftaran_layanan_perawat_id'];
												$pendaftaran_layanan_perawat_name[$index]=$arr['pendaftaran_layanan_perawat_name'];
												$pendaftaran_layanan_pemeriksaan_id[$index]=$arr['pendaftaran_layanan_pemeriksaan_id'];
												$pendaftaran_layanan_pemeriksaan_name[$index]=$arr['pendaftaran_layanan_pemeriksaan_name'];
										?>
				...
				<div class="form-group row mb-4">
					<label class="col-form-label text-md-right col-12 col-md-3 col-lg-3"></label>
					<div class="col-sm-12 col-md-7">
						<input type="hidden" class="form-control" name="pendaftaran_id" value="<?php echo $this->input->post('pendaftaran_id')?$this->input->post('pendaftaran_id'):(isset($pendaftaran_id)?$pendaftaran_id:'0'); ?>"> 

 ...
 <script>
			...
			function dataReload(link_service){
			  $('#datatables').DataTable({
				...
				'ajax': {
				  url: '<?php echo base_url('admin/'.$class.'/get_datatable_kasir');?>'+link_service,
				  type: 'post',
				  dataType: 'json',
				},
				'columns':[
					{ title: "No.", data: "no","width":"30px", visible: true}, 
					{ title: "Aksi", data: "action","width":"00px", visible: true},
					{ title: "Invoice", data: "kasir_invoice", visible: true},
					{ title: "Tgl Trx", data: "kasir_date", visible: true},
					{ title: "Nama Pasien", data: "pasien_name", visible: true},
					{ title: "Total", data: "kasir_total", visible: true},
					{ title: "Status", data: "kasir_status", visible: true}
				],
			  });

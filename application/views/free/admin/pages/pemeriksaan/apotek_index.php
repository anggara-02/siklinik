			...
			<div class="row mx-n2">
				<div class="col-md-auto mb-3 mb-md-0 px-2">
					<?php if(common_lib::hak_akses($access,'add','menu')=='1'){?>
						<!--a href="<?php echo site_url('admin/'.$class.'/apotek/add');?>" class="btn btn-primary add" shortcut="f2">Tambah</a-->
 ...
 <script>
			...
			function dataReload(link_service){
			  $('#datatables').DataTable({
				...
				'ajax': {
				  url: '<?php echo base_url('admin/'.$class.'/get_datatable_apotek');?>'+link_service,
				  type: 'post',
				  dataType: 'json',
				},
				'columns':[
					...
					{ title: "Total", data: "pemeriksaan_apotek_total", visible: true},

			...
			<form action="#" method="POST">
				<div class="form-group row mb-4">
					...
					<div class="col-sm-12 col-md-7">
						<textarea name="pemeriksaan_alergi" readonly id="pemeriksaan_alergi" cols="30" rows="5" class="form-control h-auto"><?php echo $this->input->post('pemeriksaan_alergi')?$this->input->post('pemeriksaan_alergi'):(isset($pemeriksaan_alergi)?$pemeriksaan_alergi:'');?></textarea> 
					</div>
				</div>
				<div class="form-group row mb-4">
					...
					<div class="col-sm-12 col-md-2">
						...
						<input type="number" step="0.01" readonly class="form-control" name="pemeriksaan_weight" value="<?php echo $this->input->post('pemeriksaan_weight')?$this->input->post('pemeriksaan_weight'):(isset($pemeriksaan_weight)?$pemeriksaan_weight:'');?>"  required> 
					</div>
					<div class="col-sm-12 col-md-2">
						<label>Tinggi Badan</label>
						<input type="number" step="0.01" readonly class="form-control" name="pemeriksaan_height" value="<?php echo $this->input->post('pemeriksaan_height')?$this->input->post('pemeriksaan_height'):(isset($pemeriksaan_height)?$pemeriksaan_height:'');?>"  required> 
					</div>
				</div>
				<hr>
				<div class="form-group row mb-4">
				...
				<div class="form-group row mb-4">
					...
					<div class="col-sm-12 col-md-2">
						...
						<input type="number" step="0.01" readonly class="form-control" name="pemeriksaan_tension" value="<?php echo $this->input->post('pemeriksaan_tension')?$this->input->post('pemeriksaan_tension'):(isset($pemeriksaan_tension)?$pemeriksaan_tension:'');?>"  required> 
					</div>
					<div class="col-sm-12 col-md-2">
						<label>Respiratory Rate</label>
						<input type="number" step="0.01" readonly class="form-control" name="pemeriksaan_respiration" value="<?php echo $this->input->post('pemeriksaan_respiration')?$this->input->post('pemeriksaan_respiration'):(isset($pemeriksaan_respiration)?$pemeriksaan_respiration:'');?>"  required> 
					</div>
				</div>
				<div class="form-group row mb-4">
					<label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">&nbsp;</label>
					<div class="col-sm-12 col-md-2">
						<label>Nadi</label>
						<input type="number" step="0.01" readonly class="form-control" name="pemeriksaan_nadi" value="<?php echo $this->input->post('pemeriksaan_nadi')?$this->input->post('pemeriksaan_nadi'):(isset($pemeriksaan_nadi)?$pemeriksaan_nadi:'');?>"  required> 
					</div>
					<div class="col-sm-12 col-md-2">
						<label>Suhu Tubuh</label>
						<input type="number" step="0.01" readonly class="form-control" name="pemeriksaan_suhu" value="<?php echo $this->input->post('pemeriksaan_suhu')?$this->input->post('pemeriksaan_suhu'):(isset($pemeriksaan_suhu)?$pemeriksaan_suhu:'');?>"  required> 
					</div>
				</div>
				<hr>
				<div class="form-group row mb-4">
					...
					<div class="col-sm-12 col-md-7">
						<textarea name="pemeriksaan_anamnesis" readonly id="pemeriksaan_anamnesis" cols="30" rows="5" class="form-control h-auto"><?php echo $this->input->post('pemeriksaan_anamnesis')?$this->input->post('pemeriksaan_anamnesis'):(isset($pemeriksaan_anamnesis)?$pemeriksaan_anamnesis:'');?></textarea> 
					</div>
				</div>
				<div class="form-group row mb-4">
					<label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Pemeriksaan Fisik</label>
					<div class="col-sm-12 col-md-7">
						<textarea name="pemeriksaan_pemeriksaan" readonly id="pemeriksaan_pemeriksaan" cols="30" rows="5" class="form-control h-auto"><?php echo $this->input->post('pemeriksaan_pemeriksaan')?$this->input->post('pemeriksaan_pemeriksaan'):(isset($pemeriksaan_pemeriksaan)?$pemeriksaan_pemeriksaan:'');?></textarea> 
					</div>
				</div>
				<div class="form-group row mb-4">
				...
				<div class="form-group row mb-4">
					...
					<div class="col-sm-12 col-md-9">
						...
						<a class="btn btn-primary" name="submit" href="<?php echo base_url('admin/pemeriksaan')?>">Kembali</a> 
					</div>
				</div>
			</form>
		</div>

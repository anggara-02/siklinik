	...
	<div class="card">
		<div class="card-header">
		  ...
		  <?php 
			...
			<?php } $pendaftaran_from='apotek';?>
				<div class="form-group row mb-4" <?php echo (isset($pendaftaran_from)&&$pendaftaran_from!='apotek')?'style="display:none"':$pendaftaran_from?> >
					<label class="col-form-label text-md-right col-12 col-md-3 col-lg-3"><u>Transaksi Non Resep</u></label>
				</div>
				<div class="form-group row mb-4" <?php echo (isset($pendaftaran_from)&&$pendaftaran_from!='apotek')?'style="display:none"':''?>>
					<label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">&nbsp;</label>
					<div class="col-sm-12 col-md-7">
...
{ 
	  ...
	  $("#nr_search_obat_name").autocomplete({
		  ...
		  select: function (event, ui) {
				...
				setTimeout(function() { 
					$('[name="nr_search_obat_name"]').val(ui.item.obat_name);
				}, 400);
			return false;
		  },
...
{ 
	  ...
	  $("#r_search_obat_name").autocomplete({
		  ...
		  select: function (event, ui) {
				...
				setTimeout(function() { 
					$('[name="r_search_obat_name"]').val(ui.item.obat_name);
				}, 400);
			return false;
		  },
		  focus: function (event, ui) {  

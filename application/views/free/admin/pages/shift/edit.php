				...
				<div class="row">
					<div class="col-md-8">	  
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input class="form-control" type="text" name="satuan_name" maxlength="200" value="<?php echo $this->input->post('satuan_name')?$this->input->post('satuan_name'):(isset($data['satuan_name'])?$data['satuan_name']:''); ?>" />
							</div>
						</div>   
						<div class="form-group">
							<label class="col-sm-2 control-label">
							...
							<div class="col-sm-10">
								<textarea class="form-control" name="satuan_keterangan"><?php echo $this->input->post('satuan_keterangan')?$this->input->post('satuan_keterangan'):(isset($data['satuan_keterangan'])?$data['satuan_keterangan']:''); ?></textarea>
							</div>
						</div>   
						<div class="form-group">
						<hr/> 
						...
						<div class="col-sm-4">
							<input class="form-control" type="hidden" name="satuan_id" value="<?php echo (isset($data['satuan_id'])?$data['satuan_id']:''); ?>" />

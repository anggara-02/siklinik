                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 input-group">
                                    <input type="text" class="form-control" id="keyword"
                                        placeholder="Search Kode Distribusi">
                        ...
                        <table id="datatables" class="table table-sm table-bordered text-nowrap" style="width: 100%">
                            <thead>
                                <tr class="bg-light">
                                    ...
                                    <th class="align-middle text-center" width="100">Aksi</th>
                                    <th class="align-middle text-center" width="200">Kode Distribusi</th>
                                    <th class="align-middle text-center" width="150">Tanggal Distribusi</th>
                                    <th class="align-middle text-center">Tujuan</th>
                                    <th class="align-middle text-center" width="200">Nama Item - Batch</th>
...
function load_table() {
    ...
    var kode = $("#keyword").val();

    if (checkDateRange(tanggal_awal, tanggal_akhir) != false) {
        var link_service = '?kode=' + kode + '&tanggal_awal=' + tanggal_awal + '&tanggal_akhir=' + tanggal_akhir;
        dataReload(link_service);
    } else {
        var link_service = '?kode=' + kode;
        dataReload(link_service);
    }
}

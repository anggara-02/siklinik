...
<script>
	...
	function dataReload(link_service){
		...
		'columns':[
			...
			{ title: "RM", data: "pasien_rm", visible: true},
			{ title: "Nama Pasien", data: "pasien_name", visible: true},
			{ title: "Jenis Kelamin", data: "pasien_gender", visible: true},
			{ title: "Tgl Lahir", data: "pasien_birthdate", visible: true},
			{ title: "Jenis Penjamin", data: "pasien_penjamin_name", visible: true},
			{ title: "No Penjamin", data: "pasien_penjamin_no", visible: true}
		],
		});

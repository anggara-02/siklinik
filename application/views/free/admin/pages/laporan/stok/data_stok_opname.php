                ...
                <table id="datatables" class="table table-sm table-bordered text-nowrap">
                    <thead>
                        <tr class="bg-light">
                            ...
                            <th class="align-middle text-center" width="100">Tanggal SO</th>
                            <th class="align-middle text-center" width="100">Nama Item</th>
                            <th class="align-middle text-center" width="100">Harga Satuan</th>
                            <th class="align-middle text-center" width="100">Stok Sebelum SO</th>
                            <th class="align-middle text-center" width="100">Stok Opname</th>
                            <th class="align-middle text-center" width="100">Selisih Stok</th>
                            <th class="align-middle text-center" width="100">Selisih Harga</th>
                            <th class="align-middle text-center" width="100">User</th>
                        </tr>
                    </thead>
                </table>
            </div>
...
<script>
    ...
    function dataReload(link_service){
        ...
        'columns':[
            ...
            {data: "nama_item", visible: true}, 
            {data: "harga_satuan", visible: true},
            {data: "stok_before_so", visible: true},
            {data: "stok_after_so", visible: true},
            {data: "selisih_stok", visible: true},
            {data: "selisih_harga", visible: true},

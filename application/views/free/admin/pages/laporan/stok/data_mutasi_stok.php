                ...
                <table id="datatables" class="table table-sm table-bordered text-nowrap">
                    <thead>
                        <tr class="bg-light">
                            ...
                            <th class="align-middle text-center" width="100">Tanggal Transaksi</th>
                            ...
                            <th class="align-middle text-center" width="100">Masuk</th>
                            <th class="align-middle text-center" width="100">Keluar</th>
                            <th class="align-middle text-center" width="100">Keterangan</th>
                        </tr>
                    </thead>
                </table>
            </div>

        ...
        <div class="px-4 pt-4 pb-0">
            <div class="col-md-3 ml-md-auto">
                <div class="row" style="font-weight:bold;">
                    <div class="col-md-auto"><strong>Total</strong></div>
                    <div class="col-md-auto"><?= $harga ?></div>
                </div>
            </div>
            <hr>
            <div class="row">
                ...
                <table id="datatables" class="table table-sm table-bordered text-nowrap">
                    <thead>
                        <tr class="bg-light">
                            ...
                            <th class="align-middle text-center" width="100">No R/</th>
                            <th class="align-middle text-center" width="100">Aturan Pakai</th>
...
<script>
    ...
    function dataReload(link_service){
        ...
        'columns':[
            ...
            {data: "invoice", visible: true},
            {data: "transaksi", visible: true},
            {data: "pasien_name", visible: true},
            {data: "dokter", visible: true},
            {data: "no_r", visible: true},
            {data: "aturan", visible: true},
            {data: "item", visible: true},
            {data: "barcode", visible: true},
            {data: "barang", visible: true},
            {data: "jumlah", visible: true},
            {data: "dasar", visible: true},
        ],
        });

        ...
        <div class="px-4 pt-4 pb-0">
            ...
            <div class="row">
                ...
                <div class="col-md-auto px-4 ml-auto">
                    <div class="row">
                        <div class="search">
                            <input type="date" class="form-control tooltips"
                                value="<?php echo ($this->input->get('start_date')) ? $this->input->get('start_date') : '' ?>"
                                id="tanggal_awal" title="Tanggal Awal">
                        </div>
                        <div class="search">
                            <input type="date" class="form-control tooltips"
                                value="<?php echo $this->input->get('end_date') ? $this->input->get('end_date') : '' ?>"
                                id="tanggal_akhir" title="Tanggal Akhir">
                        </div>
                ...
                <table id="datatables" class="table table-sm table-bordered text-nowrap">
                    <thead>
                        <tr class="bg-light">
                            ...
                            <th class="align-middle text-center" width="100">Tgl Transaksi</th>
                            <th class="align-middle text-center" width="100">Tgl Pelunasan</th>
                            <th class="align-middle text-center" width="100">Petugas</th>
                            <th class="align-middle text-center" width="100">Total Transaksi</th>
                            <th class="align-middle text-center" width="100">Total Bayar</th>
...
function total_tagihan(link_service) {
    $.ajax({
        ...
        success: function(response) {
            $('#_total').text(response.total_tagihan);
        }
    });
}

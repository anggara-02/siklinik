                ...
                <table id="datatables" class="table table-sm table-bordered text-nowrap" style="width: 100%">
                    <thead>
                        <tr class="bg-light">
                            ...
                            <th class="align-middle text-center" width="100">Hari</th>
                            <th class="align-middle text-center" width="100">Tanggal</th>
                            <th class="align-middle text-center" width="100">Shift</th>
                            <th class="align-middle text-center" width="100">Dokter</th>
                            <th class="align-middle text-center" width="">Jenis Pemeriksaan Laborat</th>
...
<script>
    ...
    $('#export').click(function(e) {
        ...
        location.href = "<?php echo site_url('admin/laporan/laborat/' . $class . '/export') ?>" + link_service;
    });
    ...
    function dataReload(link_service){
        ...
        'ajax': {
            url: '<?= base_url('admin/laporan/laborat/'.$class.'/get_datatable');?>' + link_service,
            type: 'post',
            dataType: 'json',
        },
        'columns':[
            {data: "no", visible: true}, 
            {data: "hari", visible: true},
            {data: "tanggal", visible: true},
            {data: "shift", visible: true},
            {data: "dokter", visible: true},
            {data: "pemeriksaan", visible: true},

...
<body>
	<div id="app">
		<div class="main-wrapper">
			...
			<div class="main-content" style="padding-left: 30px;padding-right: 30px; padding-top: 30px; width: 100%; position: relative;">
					...
					if (e.which == 27) { //esc
						if ($('[shortcut="esc"]').length > 0) {
							...
							if ($('#ModalBayar').is(':visible')) {
								...
								conf = confirm($('[shortcut="esc"]').text() + '?');
								if (conf) {
		...
		<script async src="https://www.googletagmanager.com/gtag/js?id=G-C0RBEZ251N"></script>
		<script>
